...
namespace CombatLogging.Entries
{
    public class SkillUsedCombatLogEntry : BaseCombatLogEntry
    {
        ...
        {
            return string.Format(ENTRY_FORMAT, SkillCasterOwner.Player.Name, SkillCaster.Name.PresentValue, SkillCaster.BaseEntityType.Name, SingletonContainer.Instance.TooltipManager.GenerateTooltipableURL(UsedSkill));
        }
    }
}
